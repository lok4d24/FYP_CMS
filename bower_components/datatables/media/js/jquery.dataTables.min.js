...
oPaginate:{sFirst:"第一頁",sLast:"最後一頁",sNext:"下一頁",sPrevious:"上一頁"},sEmptyTable:"沒有適合的資料",sInfo:"正在顯示第 _START_ - _END_ 項 (總數為 _TOTAL_ 項)",sInfoEmpty:"正在顯示第 0 項 (總數為 0 項)",sInfoFiltered:"<從 _MAX_ 項中過濾>",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每頁顯示 _MENU_ 項",sLoadingRecords:"載入中...",sProcessing:"處理中...",sSearch:"搜尋:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"沒有匹配的紀錄"},oSearch:h.extend({},
